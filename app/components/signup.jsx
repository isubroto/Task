  ...
  return (
    <div className="w-10/12 h-full flex flex-col gap-8 justify-center items-center">
        <div className="flex flex-col gap-2 justify-center w-full">
          ...
          <button className="border border-[#DBDECF] rounded-xl flex justify-center items-center gap-3 py-4 px-6 w-full font-semibold text-[#21211D]"><Image src={ googlesymbol } alt="google symbol" width={ 24 } height={ 24 } /> Continue with Google</button>
